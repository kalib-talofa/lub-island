...
export default function MorningBriefing({
  ...
  return (
    ...
    >
      ...
      {/* Narration text */}
      <div className="mx-4 mt-6 rounded-2xl bg-white/70 p-4 shadow-md backdrop-blur-sm">
      ...
      {/* Stats summary */}
      {textComplete && (
        <div className="mx-4 mt-4 space-y-3 animate-in fade-in">
          {/* Energy callout */}
          <div className="rounded-xl bg-white/60 px-4 py-3 shadow-sm backdrop-blur-sm">
          ...
          <button
            ...
            className="mt-2 w-full min-h-[48px] rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 py-3 text-lg font-bold text-white shadow-lg transition-all hover:scale-[1.02] active:scale-95"
          >
            Let's go! {"\u{1F31E}"}
          </button>
        </div>
